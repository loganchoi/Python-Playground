...
def test():
    ...
    try:
        ...
        move_north = rolla_quest.is_valid_move(original_curr_grid, original_row, original_col, 'w')
        move_west  = rolla_quest.is_valid_move(original_curr_grid, original_row, original_col, 'a')
        move_south = rolla_quest.is_valid_move(original_curr_grid, original_row, original_col, 's')
        move_east  = rolla_quest.is_valid_move(original_curr_grid, original_row, original_col, 'd')
