...
def test():
    ...
    try:
        ...
        new_grid_north, new_row_north, new_col_north = rolla_quest.make_move(original_curr_grid, original_row, original_col, character,'w')
        ...
        new_grid_south, new_row_south, new_col_south = rolla_quest.make_move(new_grid_north,  new_row_north, new_col_north, character,'s')            
        if  new_grid_south[10][10] == character and \
            new_grid_south[9][10] != character and \
            new_grid_south == correct_grid_south:
            moved_south = True

        new_grid_east, new_row_east, new_col_east = rolla_quest.make_move(new_grid_south,  new_row_south, new_col_south, character,'d')
        if  new_grid_east[10][11] == character and \
            new_grid_east[10][10] != character and \
            new_grid_east == correct_grid_east:
            moved_east = True

        new_grid_west, new_row_west, new_col_west = rolla_quest.make_move(new_grid_east,  new_row_east, new_col_east, character,'a')
