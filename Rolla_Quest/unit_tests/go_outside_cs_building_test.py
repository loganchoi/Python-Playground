...
def test():
    ...
    try:
        ...
        new_curr_grid_outside, new_grid_row_outside, new_grid_col_outside, new_grid_set_outside, new_grid_set_row_outside, new_grid_set_col_outside, inside_to_outside_new_floor_number = rolla_quest.go_outside_cs_building()
