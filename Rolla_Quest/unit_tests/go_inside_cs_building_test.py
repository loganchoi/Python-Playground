...
def test():
    ...
    try:
        ...
        new_curr_grid_second_floor, new_grid_row_second_floor, new_grid_col_second_floor, new_grid_set_second_floor, new_grid_set_row_second_floor, new_grid_set_col_second_floor, outside_to_inside_new_floor_number = rolla_quest.go_inside_cs_building(floor_map[2], 2)

        # starting from second floor going to first floor
        new_curr_grid_first_floor, new_grid_row_first_floor, new_grid_col_first_floor, new_grid_set_first_floor, new_grid_set_row_first_floor, new_grid_set_col_first_floor, second_to_first_new_floor_number = rolla_quest.go_inside_cs_building(floor_map[1], 1)

        # starting from second floor going to third floor
        new_curr_grid_third_floor, new_grid_row_third_floor, new_grid_col_third_floor, new_grid_set_third_floor, new_grid_set_row_third_floor, new_grid_set_col_third_floor, second_to_third_new_floor_number = rolla_quest.go_inside_cs_building(floor_map[3], 3)
